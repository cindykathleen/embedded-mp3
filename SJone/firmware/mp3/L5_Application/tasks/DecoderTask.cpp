...
static void Init_DecoderTask(void)
{
    // Initialize SPI 0
    ssp0_init(0);
...
void DecoderTask(void *p)
{
    ...
    while (1)
    {
        ...
        if ( xSemaphoreTake(ButtonSemaphores[0], 0) ) printf("Button 0 pressed!\n");
        if ( xSemaphoreTake(ButtonSemaphores[1], 0) ) printf("Button 1 pressed!\n");
        if ( xSemaphoreTake(ButtonSemaphores[2], 0) ) printf("Button 2 pressed!\n");
        if ( xSemaphoreTake(ButtonSemaphores[3], 0) ) printf("Button 3 pressed!\n");
        if ( xSemaphoreTake(ButtonSemaphores[4], 0) ) printf("Button 4 pressed!\n");
        if ( xSemaphoreTake(ButtonSemaphores[5], 0) ) printf("Button 5 pressed!\n");
